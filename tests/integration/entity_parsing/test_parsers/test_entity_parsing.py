...
class TestEntityParserWithEmptyValueParserCapitalized_ShouldSucceed(
...
class TestEntityParserPrefixesAndSuffixes_ShouldSucceed(
    _TestEntityParsingBaseCase):
...
class TestEntityParserIdentifiers_ShouldSucceed(_TestEntityParsingBaseCase):
...
class TestEntityParserIdentifiersPrefixesSuffiixes_ShouldFail(
    _TestEntityParsingBaseCase):
...
class TestEntityParserIdentifiersPrefixesSuffiixes_ShouldSucceed(
    _TestEntityParsingBaseCase):
    mock_intent_cls = TestableEntityParserIntentUsingIdentifierAndPrefixesSuffixes
...
class TestEntityParserChoiceParserWithCaseMixedChoices_ShouldSucceed(
    _TestEntityParsingBaseCase):
...
class TestEntityParserChoiceParser_Capitalized_ShouldSucceed(
    _TestEntityParsingBaseCase):
    mock_intent_cls = TestableEntityParserIntentUsingIdentifierAndPrefixesSuffixes_CapitalizedChoices
    mock_message = Message("I love the colors of October")
...
class TestEntityParserIDentifierPrefixesSuffixesMultipleChoices_1_ShouldSucceed(
    _TestEntityParsingBaseCase):
...
class TestEntityParserIDentifierPrefixesSuffixesMultipleChoices_3_ShouldSucceed(
    _TestEntityParsingBaseCase):
    ...
    def test_respond(self):
        ...
        pages = self.get_entity_value("pages")
        self.assertEqual(OrderedSet(['page_b', 'page_a']), pages)
        self.assertEqual("60", self.get_entity_value("maximum_results"))
        self.assertEqual("45000", self.get_entity_value("minimum_price"))


class EntityParserShouldIgnoreLeadAndTrailInEntities_ShouldSucceed(
    _TestEntityParsingBaseCase):
